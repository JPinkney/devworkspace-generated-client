...
*/
export class V1alpha1DevWorkspaceSpecTemplateProjectsItemsGitCheckoutFrom {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return V1alpha1DevWorkspaceSpecTemplateProjectsItemsGitCheckoutFrom.attributeTypeMap;
    }
}
