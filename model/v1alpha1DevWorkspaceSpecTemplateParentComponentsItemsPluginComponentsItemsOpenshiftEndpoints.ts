...
export class V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginComponentsItemsOpenshiftEndpoints {
    /**
    ...
    */
    'exposure'?: V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginComponentsItemsOpenshiftEndpoints.ExposureEnum;
    'name': string;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "exposure",
            "baseName": "exposure",
            "type": "V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginComponentsItemsOpenshiftEndpoints.ExposureEnum"
        },
        {
            "name": "name",
            "baseName": "name",
    ...
    static getAttributeTypeMap() {
        return V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginComponentsItemsOpenshiftEndpoints.attributeTypeMap;
    }
}

export namespace V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginComponentsItemsOpenshiftEndpoints {
