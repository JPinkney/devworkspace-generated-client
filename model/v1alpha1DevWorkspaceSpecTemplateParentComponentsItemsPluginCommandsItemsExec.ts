...
import { V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginCommandsItemsExecEnv } from './v1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginCommandsItemsExecEnv';
import { V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginCommandsItemsExecGroup } from './v1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginCommandsItemsExecGroup';

/**
* CLI Command executed in an existing component container
*/
export class V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginCommandsItemsExec {
    /**
    ...
    */
    'env'?: Array<V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginCommandsItemsExecEnv>;
    'group'?: V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginCommandsItemsExecGroup;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "env",
            "baseName": "env",
            "type": "Array<V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginCommandsItemsExecEnv>"
        },
        {
            "name": "group",
            "baseName": "group",
            "type": "V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginCommandsItemsExecGroup"
        },
        {
    ...
    static getAttributeTypeMap() {
        return V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginCommandsItemsExec.attributeTypeMap;
    }
}
