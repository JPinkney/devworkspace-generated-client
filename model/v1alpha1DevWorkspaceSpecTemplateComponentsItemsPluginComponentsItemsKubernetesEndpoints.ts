...
export class V1alpha1DevWorkspaceSpecTemplateComponentsItemsPluginComponentsItemsKubernetesEndpoints {
    /**
    ...
    */
    'exposure'?: V1alpha1DevWorkspaceSpecTemplateComponentsItemsPluginComponentsItemsKubernetesEndpoints.ExposureEnum;
    'name': string;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "exposure",
            "baseName": "exposure",
            "type": "V1alpha1DevWorkspaceSpecTemplateComponentsItemsPluginComponentsItemsKubernetesEndpoints.ExposureEnum"
        },
        {
            "name": "name",
            "baseName": "name",
    ...
    static getAttributeTypeMap() {
        return V1alpha1DevWorkspaceSpecTemplateComponentsItemsPluginComponentsItemsKubernetesEndpoints.attributeTypeMap;
    }
}

export namespace V1alpha1DevWorkspaceSpecTemplateComponentsItemsPluginComponentsItemsKubernetesEndpoints {
