...
export class V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginComponentsItemsContainerEndpoints {
    /**
    ...
    */
    'exposure'?: V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginComponentsItemsContainerEndpoints.ExposureEnum;
    'name': string;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "exposure",
            "baseName": "exposure",
            "type": "V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginComponentsItemsContainerEndpoints.ExposureEnum"
        },
        {
            "name": "name",
            "baseName": "name",
    ...
    static getAttributeTypeMap() {
        return V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginComponentsItemsContainerEndpoints.attributeTypeMap;
    }
}

export namespace V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginComponentsItemsContainerEndpoints {
