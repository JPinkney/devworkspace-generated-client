...
import { V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginCommandsItemsCustomGroup } from './v1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginCommandsItemsCustomGroup';
...
*/
export class V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginCommandsItemsCustom {
    /**
    ...
    */
    ...
    'group'?: V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginCommandsItemsCustomGroup;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "group",
            "baseName": "group",
            "type": "V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginCommandsItemsCustomGroup"
        },
        {
            "name": "id",
            "baseName": "id",
    ...
    static getAttributeTypeMap() {
        return V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsPluginCommandsItemsCustom.attributeTypeMap;
    }
}
