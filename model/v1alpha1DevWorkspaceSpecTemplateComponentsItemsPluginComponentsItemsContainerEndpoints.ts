...
export class V1alpha1DevWorkspaceSpecTemplateComponentsItemsPluginComponentsItemsContainerEndpoints {
    /**
    ...
    */
    'exposure'?: V1alpha1DevWorkspaceSpecTemplateComponentsItemsPluginComponentsItemsContainerEndpoints.ExposureEnum;
    'name': string;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "exposure",
            "baseName": "exposure",
            "type": "V1alpha1DevWorkspaceSpecTemplateComponentsItemsPluginComponentsItemsContainerEndpoints.ExposureEnum"
        },
        {
            "name": "name",
            "baseName": "name",
    ...
    static getAttributeTypeMap() {
        return V1alpha1DevWorkspaceSpecTemplateComponentsItemsPluginComponentsItemsContainerEndpoints.attributeTypeMap;
    }
}

export namespace V1alpha1DevWorkspaceSpecTemplateComponentsItemsPluginComponentsItemsContainerEndpoints {
