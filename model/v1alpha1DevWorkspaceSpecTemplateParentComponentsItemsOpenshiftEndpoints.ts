...
export class V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints {
    /**
    ...
    */
    'exposure'?: V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints.ExposureEnum;
    'name': string;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "exposure",
            "baseName": "exposure",
            "type": "V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints.ExposureEnum"
        },
        {
            "name": "name",
            "baseName": "name",
    ...
    static getAttributeTypeMap() {
        return V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints.attributeTypeMap;
    }
}

export namespace V1alpha1DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints {
