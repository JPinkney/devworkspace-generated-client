...
import { V1alpha1DevWorkspaceSpecTemplateCommandsItemsCustomGroup } from './v1alpha1DevWorkspaceSpecTemplateCommandsItemsCustomGroup';
...
*/
export class V1alpha1DevWorkspaceSpecTemplateCommandsItemsCustom {
    /**
    ...
    */
    ...
    'group'?: V1alpha1DevWorkspaceSpecTemplateCommandsItemsCustomGroup;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "group",
            "baseName": "group",
            "type": "V1alpha1DevWorkspaceSpecTemplateCommandsItemsCustomGroup"
        },
        {
            "name": "id",
            "baseName": "id",
    ...
    static getAttributeTypeMap() {
        return V1alpha1DevWorkspaceSpecTemplateCommandsItemsCustom.attributeTypeMap;
    }
}
